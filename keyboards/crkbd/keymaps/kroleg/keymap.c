...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_split_3x5_3(
		KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,        KC_Y,    KC_U,    KC_I,    KC_LBRC, XXXXXXX,
		HOME_A,  QH_S,    QH_D,    QH_F,    KC_G,        KC_H,    QH_J,    QH_K,    QH_L,    QH_SCLN,
		KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_P,
                          KC_TAB,  OSL(_SYM_RU), KC_ENT,  SFT_SPC, OSL(_NAV), OSM_HYPR
	),
    [_COLEMAK] = LAYOUT_split_3x5_3(
		...
		KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,        KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_EXLM,
                          _______, OSL(_SYM), _______,    _______,  _______, _______
	),
	...
	[_NAV] = LAYOUT_split_3x5_3(
		KC_DOT,  KC_4,    KC_3,    KC_2,    KC_1,        KC_VOLU, KC_HOME, KC_UP,   KC_END,  XXXXXXX,
		OSM_LCTL,OSM_LALT,OSM_LSFT,OSM_LGUI,KC_0,        CMDTAB,  KC_LEFT, KC_DOWN, KC_RGHT, KC_ESC,
		KC_9,    KC_8,    KC_7,    KC_6,    KC_5,        KC_VOLD, SFT_TAB, KC_BSPC, KC_TAB,  XXXXXXX,
		                  _______, _______, _______,     _______, _______, _______
	),
    [_THIRD] = LAYOUT_split_3x5_3(
		SW_LANG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, MS_BTN1, MS_UP,   MS_BTN2, XXXXXXX,
		XXXXXXX, XXXXXXX, XXXXXXX, KC_F13,  XXXXXXX,     XXXXXXX, MS_LEFT, MS_DOWN, MS_RGHT, XXXXXXX,
		QK_BOOT, DB_TOGG, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
